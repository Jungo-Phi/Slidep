...
describe("graduation_step", () => {
  it("keeps labelled lines within LABEL_PITCH_FLOOR_PX/CEILING_PX at every zoom", () => {
    // Injected rather than re-derived: what this checks is that the ladder's own envelope tracks the floor, whatever the floor is currently set to — not that it's 40 or 50.
