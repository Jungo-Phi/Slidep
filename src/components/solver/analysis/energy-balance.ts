...
export interface EnergyBalanceSeries {
  ...
  mechanical: number[];
  /**
   * J — cumulative net work IN since the start of the recording: every motor's own power (`DynamicSnapshot.motorPower`, summed) minus what the dampers and the frictional joints bled off (`EnergySample.damperPower`/`frictionPower`), integrated trapezoidally over the recorded frames.
