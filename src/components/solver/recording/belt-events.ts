 ...
 *
 * Pure, and cheap enough to redo whenever the recording grows: memoise it on the snapshot array rather than keeping a running state, which a scrub would have to unwind anyway.
 *
