...
Slidep est un laboratoire de mécanique virtuel. Conçu pour une prise en main immédiate, il vous permet de construire et de voir évoluer vos mécanismes en temps réel, directement dans votre navigateur.

C'est l'espace idéal pour apprendre, prototyper et valider vos idées, transformant rapidement une intuition en un mécanisme fonctionnel tout en identifiant les blocages et en permettant d'analyser son comportement.
