...
*C'est la zone "Contexte et Données". Elle gère tout ce qui concerne la persistance et la navigation entre les projets.*
...
*C'est la zone "Action et Temps". Elle est le cœur visuel de l'application et s'anime selon le mode actif.*
...
*C'est la zone "Interaction et Configuration". Elle regroupe les outils de manipulation du canvas, l'historique et les paramètres globaux.*
...
*   **Sections :**
    ...
    * **Dynamique** (Amortisseur, Ressort, Masse)
    * **Contraintes** (Dimension, Ratio, Égale, Alignement, Perpendiculaire, Parallèle)
    * **Simulation** (Force, Moment, Moteur, Balise)
...
1.  **Phase 1 (MVP) :**
    ...
    *   *Note :* La statique peut est approchée par itération manuelle en mode Dynamique.
